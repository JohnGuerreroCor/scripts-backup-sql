...
select * from persona p where p.per_nombre like '%NIDIA%' and p.per_apellido like '%GUZMAN%'SELECT * FROM persona p where p.per_apellido like '%CORDOBA DIAZ%'
SELECT * FROM persona p where p.per_apellido like '%CUELLAR SALAS%'SELECT * FROM persona p where p.per_apellido like '%Gomez Aguirre%'
