...
-------------TABLA FUNCIONES--------------
------------------------------------------
CREATE TABLE funciones_curpos_colegiados (
...
CREATE TABLE cuerpos_colegiados (
    cuc_codigo INT IDENTITY(1,1) PRIMARY KEY,
    cuc_nombre NVARCHAR(20) NOT NULL,
    cuc_nombre_corto NVARCHAR(50) NOT NULL,
    nor_codigo INT NOT NULL,
    cuc_fecha_creacion DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL,
    cuc_cantidad_miembros INT NOT NULL,
    cuc_estado INT DEFAULT 1 NOT NULL,
    CONSTRAINT cuerpos_colegiados_FK_norma FOREIGN KEY (nor_codigo) REFERENCES norma(nor_codigo)
);
